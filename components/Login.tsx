    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4 overflow-y-auto">
      <div className="w-full max-w-md bg-slate-800 rounded-2xl shadow-xl border border-slate-700 p-6 md:p-8 my-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Join the session</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-6 gap-2 p-2 bg-slate-900 rounded-lg border border-slate-700 max-h-32 overflow-y-auto scrollbar-hide">
            {AVATARS.map((avatar) => (
                <button
                key={avatar}
                type="button"
